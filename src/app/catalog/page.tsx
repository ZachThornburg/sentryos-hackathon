...
import { Download, ExternalLink, Settings, FileText, Presentation, Video, Mail, Calculator, Shield } from 'lucide-react'
...
export default function CatalogPage() {
  ...
  const currentAssets = sampleAssets.filter(asset => asset.stage === activeStage)
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#9086a3]">
            {currentAssets.length} resources available for this stage
          </p>
        </div>
